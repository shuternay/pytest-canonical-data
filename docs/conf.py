# -*- coding: utf-8 -*-
#
# pytest-canonical-data documentation build configuration file, created by
...
project = u'pytest-canonical-data'
copyright = u'2015, Sergey Kiselev'
author = u'Sergey Kiselev'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-canonical-data Documentation',
     [author], 1)
]
